...
<section class="mb-4">
  ...
  <div class="container">
      @if(!empty($homeCategory->category->home_banner))
      <div class="row" style="padding: 0px 15px;"><img src="{{ asset($homeCategory->category->home_banner) }}" style="width: 100%;
    height: 120px;
    margin-bottom: 15px;
    object-fit: fill;" alt=""/></div>
      @endif
              ...
              @foreach (json_decode($homeCategory->subsubcategories) as $key => $subsubcategory)
                  ...
                  <div class="tab-pane fade @php if($key == 0) echo 'show active'; @endphp" id="subsubcat-{{ $subsubcategory }}">
                    <div class="caorusel-box arrow-round gutters-5">
                        <div class="slick-carousel" data-slick-items="6" data-slick-xl-items="5" data-slick-lg-items="4"  data-slick-md-items="3" data-slick-sm-items="2" data-slick-xs-items="2" data-slick-rows="6">
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        <div class="p-md-3 p-2">
                                            ...
                                            <h2 class="product-title p-0 text-truncate-2">
                                                <a href="{{ route('product', $product->slug) }}">{{ __(str_limit($product->name, 22)) }}</a>
                                            </h2>
