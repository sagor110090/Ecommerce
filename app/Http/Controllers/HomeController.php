...
class HomeController extends Controller
{
    ...
    public function ajax_search(Request $request)
    {
        ...
        if(sizeof($keywords)>0 || sizeof($subsubcategories)>0 || sizeof($products)>0 || sizeof($shops) >0){
            return view('frontend.partals.search_content', compact('products', 'subsubcategories', 'keywords', 'shops'));
        }
        return '0';
    }
    ...
    public function search(Request $request)
    {
        ...
        $slider_banner = DB::table('banners')->where('category_id', $category_id)->get();

        return view('frontend.product_listing', compact('products', 'query','slider_banner', 'category_id', 'subcategory_id', 'subsubcategory_id', 'brand_id', 'sort_by', 'seller_id','min_price', 'max_price', 'attributes', 'selected_attributes', 'all_colors', 'selected_color'));
    }
